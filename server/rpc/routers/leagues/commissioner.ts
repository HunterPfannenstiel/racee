...
import { CommissionerPlayerStatusQuery } from "@/server/queries/commissioner-player-status/CommissionerPlayerStatusQuery";
import { CommissionerPlayerPredictionsQuery } from "@/server/queries/commissioner-player-predictions/CommissionerPlayerPredictionsQuery";
...
const playerStatusQuery = new CommissionerPlayerStatusQuery(leagueRepo, userRepo, raceRepo, bookRepo);
const playerPredictionsQuery = new CommissionerPlayerPredictionsQuery(leagueRepo, racerRepo, raceRepo, bookRepo);
