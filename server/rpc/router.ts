...
import { resultsRouter } from "@/server/rpc/routers/results";
import { playerVsPlayerRouter } from "@/server/rpc/routers/player-vs-player";
...
export const router = {
  ...
  playerVsPlayer: playerVsPlayerRouter,
};
