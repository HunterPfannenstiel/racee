...
export function SeasonsSection({ seasons, onSeasonsChange, onError }: Props) {
  ...
  return (
    <Card>
      <CardHeader>
        <h2 className="text-xs font-semibold uppercase tracking-widest text-muted-foreground">Seasons</h2>
      </CardHeader>
        ...
        <div className="grid grid-cols-3 gap-2">
          ...
          {isAddingNew ? (
            <div className="col-span-3 flex gap-2">
              ...
              <Button variant="ghost" onClick={() => { setIsAddingNew(false); setNewSeasonName(""); }} disabled={busy}>
                Cancel
              </Button>
            </div>
          ) : (
